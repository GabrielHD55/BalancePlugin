...
public class MySQL extends DataHandler {
    ...
    public MySQL(Balance plugin, String host, String port, String database, String username, String password) {
        this.plugin = plugin;
    ...
    private synchronized void setConnectionArguments() throws RuntimeException {
        (this.ds = new HikariDataSource()).setPoolName("BalancePlugin MySQL");
